...
export const VULVA_PARTS: VulvaPart[] = [
  ...
  },
  {
    name: 'G点',
    color: '#f0abfc',
    desc: '阴道前壁约 2.5–5 cm 处的敏感区域，研究认为与阴蒂内部结构、尿道旁腺相关。其存在与定位在科学上仍有讨论，并非每个人都明显',
  },
  {
    name: '会阴',
    color: '#c4b5fd',
...
export const VULVA_FACTS: VulvaFact[] = [
  ...
  },
  {
    ...
    title: '敏感带没有“标准位置”',
    content:
      'G 点不是一个“按钮”，目前研究更倾向于认为它是阴蒂内部结构（阴蒂脚、前庭球）与阴道前壁神经血管的交汇区。每个人的敏感地图都不同 —— 探索自己的感受，比寻找教科书上的位置更重要。',
  },
  {
    icon: 'Hand',
    title: '用镜子看看自己',
